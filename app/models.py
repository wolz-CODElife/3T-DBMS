...
class Students(db.Model):
    ...
    tutorial_fee = db.Column(db.Float, default=0)
    course_fee = db.Column(db.Float, default=0)
    payment_1 = db.Column(db.Float, default=0)
    payment_2 = db.Column(db.Float, default=0)
    payment_3 = db.Column(db.Float, default=0)
